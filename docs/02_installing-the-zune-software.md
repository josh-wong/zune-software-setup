...
<img src="../assets/screenshots/microsoft_license_accept.png?raw=true" />

7. In the window "Zune is ready to install", uncheck **Send info about setup to help improve experience**. Then, click **Install**.
<img src="../assets/screenshots/zune_software_install.png?raw=true" />
...
<img src="../assets/screenshots/zune_software_installation_complete.png?raw=true" />